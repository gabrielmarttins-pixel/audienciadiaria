...
async function exportHtml(){{
  ...
  clone.querySelectorAll('svg').forEach(el=>el.replaceChildren());
  clone.querySelectorAll('#dailyInsights,#legend1,#legend2,#legend3,#legend4,#leadership,#rankings,#minuteTable,#profileGrid,#mobileSummary,#tabletSummary').forEach(el=>el.innerHTML='');
  clone.querySelectorAll('#dateLabel,#dailyAvg,#programTitle,#profileTitle,#sourceNote').forEach(el=>el.textContent='');
  clone.querySelectorAll('#globoKpiLogo').forEach(el=>el.removeAttribute('src'));
